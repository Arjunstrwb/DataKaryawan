        ...
        Try
            Using con As New SQLiteConnection(_connectionString)
                ...
                Using cmd As New SQLiteCommand(con)
                    sqlstr = "INSERT INTO tblStatusKawin ([IdStatusKawin], [StatusKawin])
                            VALUES ('" + txtIdPerk.Text + "','" + txtStatPerk.Text + "')"
    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        ...
        Try
            Using con As New SQLiteConnection(_connectionString)
                ...
                Using cmd As New SQLiteCommand(con)
                    sqlstr = "UPDATE tblStatusKawin set [Statuskawin] = '" + txtStatPerk.Text + "'
                              WHERE (IdStatusKawin='" + txtIdPerk.Text + "')"
                    cmd.CommandText = sqlstr
                    cmd.ExecuteNonQuery()
                End Using
            End Using
